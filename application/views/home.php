...
<header id="header" class="navbar">
    ...
    <a class="navbar-brand" href="index.html#">Kilifi County</a>
...
<section id="content">
    <section class="main padder">
                ...
                <section class="panel">
                    <div class="carousel slide auto panel-body" id="c-slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item">
                                <img class="img-responsive" src="images/fall.jpg">
                            ...
                            <div class="item">
                                <img class="img-responsive" src="images/amboseli.jpg">
        ...
        <div class="row">
            <div  class="col-lg-6" >
            <p>
                <a href="buttons.html#" class="btn btn-info btn-block"><i class="fa fa-calendar pull-left"></i>
                    Plan for a trip</a>
            </p>

                <p>
                    <a href="buttons.html#" class="btn btn-s-large btn-info btn-block"><i class="fa fa-globe pull-left"></i>
                        View tour destinations</a>
                </p>

                <p>
                    <a href="buttons.html#" class="btn btn-info btn-block"><i class="fa fa-credit-card pull-left"></i>
